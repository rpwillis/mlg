...
EnumFolder args(0) + "Images", "Images"

oDDF.WriteLine """"+args(0) + "manifest.xml" +""""+ vbTab + "manifest.xml"
' add the resource file to the global resources folder at /12/resources
oDDF.WriteLine """"+args(0) + "MLGSchool_onet.resx" +""""+ vbTab + "resources\MLGSchool_onet.resx"

'add the dll
oDDF.WriteLine """"+args(0) +"bin\"+args(2)+"\"+ "MLGSchool.dll" +""""+ vbTab + "MLGSchool.dll"
