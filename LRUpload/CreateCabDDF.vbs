...
'add the dll
oDDF.WriteLine """"+args(0) +"bin\"+args(2)+"\"+ "MLG2007.WebParts.LRUpload.dll" +""""+ vbTab + "MLG2007.WebParts.LRUpload.dll"
oDDF.WriteLine """"+args(0) +"DLLs\"+ "Microsoft.LearningComponents.Compression.dll" +""""+ vbTab + "Microsoft.LearningComponents.Compression.dll"
